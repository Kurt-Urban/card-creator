  ...
  return (
    <div className="rounded-lg border border-slate-700 bg-slate-900/90 p-2 transition hover:border-cyan-300">
      ...
      <button
        ...
        className="mt-2 w-full rounded-lg border border-emerald-500/70 bg-emerald-500/10 px-3 py-2 text-xs font-semibold text-emerald-100 transition hover:bg-emerald-500/20 disabled:cursor-not-allowed disabled:opacity-60"
      >
