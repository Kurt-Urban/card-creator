...
Latest release: Check the [Releases page](https://github.com/Kurt-Urban/card-creator/releases/latest).

- Windows (.exe): Generated by GitHub Actions on tagged releases.
- macOS (.dmg): Generated by GitHub Actions on tagged releases.

<!-- INSTALLER_LINKS:START -->

Generated links will be inserted automatically by workflow.
